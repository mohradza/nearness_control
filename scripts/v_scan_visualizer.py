...
rospy.Subscriber( "/nearness_controller/vert_depth_reformat" , Float32MultiArray , depth_scan_cb )
rospy.Subscriber( "/nearness_controller/vert_nearness" , Float32MultiArray , nearness_cb )
